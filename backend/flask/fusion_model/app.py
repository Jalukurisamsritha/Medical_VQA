...
dataset = load_dataset(
    "csv",
    data_files={
        "train": os.path.join("..", r"C:\Users\jaluk\OneDrive\Desktop\pathology\pathvqa\model", "trainpvqaimg.csv"),
        "test": os.path.join("..", r"C:\Users\jaluk\OneDrive\Desktop\pathology\pathvqa\model", "testpvqaimg.csv")
    }
)

with open(os.path.join("..", r"C:\Users\jaluk\OneDrive\Desktop\pathology\pathvqa\model", "unique_answers.txt")) as f:
...
class MultimodalCollator:
    ...
    def preprocess_images(self, images: List[str]):
        processed_images = self.preprocessor(
            images=[Image.open(os.path.join("..", r"C:\Users\jaluk\OneDrive\Desktop\pathology\Medical_Image_question_answering\backend\flask\fusion_model\uploads",   image_id + ".jpg")).convert('RGB') for image_id in images],
            return_tensors="pt",
        )
        return {
...
with open(r"C:\Users\jaluk\OneDrive\Desktop\pathology\pathvqa\modelcol.pkl", 'rb') as file:
...
def predict():
    try:
        ...
        user_input = [
            {'image': actual_image, 'question': question, 'answer': 'yes', 'label': 547},
